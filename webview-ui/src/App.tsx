...
import WorkspaceEditorView from "./components/editor/WorkspaceEditorView"
...
type Tab = "settings" | "history" | "chat" | "marketplace" | "cloud" | "editor"
...
const App = () => {
	...
	return showWelcome ? (
		...
		<>
			...
			{tab === "editor" && <WorkspaceEditorView onDone={() => switchTab("chat")} />}
			<ChatView
				ref={chatViewRef}
				isHidden={tab !== "chat"}
